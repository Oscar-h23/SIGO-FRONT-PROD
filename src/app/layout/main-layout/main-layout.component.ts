import{Component,HostListener,signal}from'@angular/core';import{Router,RouterLink,RouterLinkActive,RouterOutlet}from'@angular/router';import{AuthService}from'../../core/auth/auth.service';import{ModuloSigo}from'../../core/auth/auth.models';import{ChatComponent}from'../../features/chat/chat.component';
